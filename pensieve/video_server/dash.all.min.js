    ...
    8: [function(a, b, c) {
        ...
        function e() {
            ...
            function e() {
                ...
                // log.innerHTML = "Hello from dash.all.min.js"
                var a = "",
                    b = null;
            ...
            function g() {
                if (!(xa || Ba || !Ma || Fa.isPaused() && !Pa)) {
                    ...
                    if (b || a) {
                        ...
                        //trigger a call to web-server to fetch LTE throughput
                        document.getElementById("fetch_lte_info").click();
                        var lte_info = document.getElementById("log_lte").value;
                        var lte_throughput = lte_info.split(",")[0];
                        var lte_off = lte_info.split(",")[1];
                        Ba = !0, a ? c() : (console.log("CALLING ABR STUFF"), Ha.getPlaybackQuality(Ia, c, Ma.getBufferLevel(), Ma.getRebufferTime(),lte_throughput, lte_off))
                    } else k(500)
                }
            }
